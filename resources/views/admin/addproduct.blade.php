    ...
    <div class="card-body">
      <form action="" method="POST">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <textarea class="from-control" name="" id="" cols="103" rows="6"></textarea>
          </div>
        </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <textarea class="from-control" name="" id="" cols="103" rows="10"></textarea>
          </div>
        </div>
        ...
        <div class="row mb-3">
          <label class="col-sm-2 col-form-label" for="basic-default-name">Add Product </label>
          <div class="col-sm-10">
            <select class="form-select" id="category" name="category" aria-label="Default select example">
              <option selected>Open this select menu</option>
              <option value="1">One</option>
