    ...
    <div class="card-body">
      <form action="{{route('storeproduct')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <textarea class="from-control" name="product_short_des" id="product_short_des" cols="103" rows="6"></textarea>
          </div>
        </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <textarea class="from-control" name="product_long_des" id="product_long_des" cols="103" rows="10"></textarea>
          </div>
        </div>
