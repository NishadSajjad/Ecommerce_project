...
<div class="col-xxl">
  <div class="card mb-4">
    ...
    <div class="card-body">
      <form action="{{route('updateproduct', $productinfo)}}" method="POST">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <textarea class="from-control" name="product_short_des" id="product_short_des" cols="103" rows="6">{{$productinfo->product_short_des}}</textarea>
          </div>
        </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <textarea class="from-control" name="product_long_des" id="product_long_des" cols="103" rows="10">{{$productinfo->product_long_des}}</textarea>
          </div>
        </div>
