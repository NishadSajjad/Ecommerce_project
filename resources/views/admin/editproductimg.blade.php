  ...
  <div class="card mb-4">
    ...
    <div class="card-body">
      <form action="{{route('updateproductimg')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row mb-3">
          <label class="col-sm-2 col-form-label" for="basic-default-name">Previous Product Name</label>
          <div class="col-sm-10">
        ...
        <div class="row mb-3">
          <label class="col-sm-2 col-form-label" for="basic-default-name"> Uplod New Image</label>
          <div class="col-sm-10">
